...
function editContact(index){
	...
	var mobile_num = $(".mobile_num_"+index).html();
	var url_add = $(".url_add_"+index).html();
	var birth_day = $(".birth_day_"+index).html();
	var birth_month = $(".birth_month_"+index).html();
	var birth_year = $(".birth_year_"+index).html();
	var city = $(".city_"+index).html();
	var personality = $(".personality_"+index).html();
	var interest = $(".interest_"+index).html();
	$("#first_name").val(first_name);
	$("#last_name").val(last_name);
	$("#email_add").val(email_add);
	$("#mobile_num").val(mobile_num);
	$("#url_add").val(url_add);
	$("#birth_day option").html(birth_day);
	$("#birth_month option").html(birth_month);
